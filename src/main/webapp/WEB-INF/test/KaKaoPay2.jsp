...
<link rel="stylesheet" type="text/css"
	href="//t1.daumcdn.net/kakaopay/tesla/20180108/pg_web/css/common.min.css">
<script
...
<script>
	var hash = "de6ef476ca3b6ca24b0e8661d76029cfff5e2c1821f19f23c29b27370d094e25";
	var failUrl = "https://developers.kakao.com/payment/web/fail/d6a7d7fd-1967-4dc1-9745-e9832fcb8bee";
	var remainingSec = 900;
	var cancelUrl = "https://developers.kakao.com/payment/web/cancel/d6a7d7fd-1967-4dc1-9745-e9832fcb8bee";
...
<script type="text/javascript"
	src="/resources/js/common_payment.js?v=version"></script>

<script type="text/javascript"
	src="/resources/js/user_info.js?v=version"></script>
...
<body>
	...
	<div class="kakaopay_layer">
		<div class="inner_kakaopay">
			...
			<div class="layer_body">
				<p class="txt_step">
					결제요청 메시지 전송을 위해<br> 카카오페이에 가입된<br>휴대폰 번호와 생년월일 6자리를
					입력해주세요.
				</p>
				<form id="userPost" method="post"
					action="/v1/de6ef476ca3b6ca24b0e8661d76029cfff5e2c1821f19f23c29b27370d094e25/uinfo">
					<fieldset>
						<legend class="screen_out">휴대폰 번호 및 생년월일 입력</legend>
						<div class="info_data">
							<span class="tit_data" id="thPhone_data"> <label
								for="tfPhone" class="lab_data">휴대폰 번호</label> <em
								class="txt_emph">특수문자 없이 숫자만 입력해주세요.</em>
							</span> <input type="text" id="tfPhone" class="tf_kakaopay"
								maxlength="11" placeholder="예) 01056781234" name="tel"
								autocomplete="off"> <span class="line_tf"><span
								class="inner_line"></span></span>
						</div>
						<div class="info_data" id="thBirthday_data">
							<span class="tit_data"> <label for="tfBirthday"
								class="lab_data">생년월일</label> <em class="txt_emph">생년월일은
									6자리로 입력해주세요. 예) 840101</em>
							</span> <input type="text" id="tfBirthday" class="tf_kakaopay"
								maxlength="6" placeholder="예) 840301" name="birthDate"
								autocomplete="off"> <span class="line_tf"><span
								class="inner_line"></span></span>
						</div>
						<div class="area_btn">
