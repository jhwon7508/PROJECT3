...
<script
	src="//t1.daumcdn.net/kakaopay/tesla/20180108/pg_web/js/lib/spin.min.js"></script>
...
<body>
	...
	<div class="kakaopay_layer">
		...
		<div class="inner_kakaopay">
			...
			<div class="layer_body">
				<p class="txt_step">
					입력하신 휴대폰 번호로<br>결제 메시지가 전송되었습니다.
				</p>
				<form>
					<fieldset>
						...
						<ol class="list_order">
							...
							<li><em class="emph_num">2</em><em class="emph_info">하단의
									결제 완료 버튼</em>을 눌러주세요.</li>
						</ol>
						<div class="area_btn">
		...
		<form id="approvalPost" action="approval" method="post"></form>
	</div>
